    ...
    <div className="hostelPage">
      <div className="container">
        ...
        <div className="actionButtons">
          <button onClick={() => navigate("/hostel/enroll")}>Enroll Inmate</button>
          <button onClick={() => navigate("/hostel/viewhdf")}>
            HDF Duesheet
          </button>
          <button onClick={() => navigate("/hostel/viewrent")}>
            Rent Duesheet
          </button>
        </div>
        ...
        <table>
          ...
          <tbody>
            {students.map((s) => {
              ...
              const monthlyFee =
                feeType === "rent" ? monthlyRent : monthlyHDF;

              const totalFee =
                feeType === "rent" ? totalRent : totalHDF;
                ...
                <tr key={s.id}>
                  ...
                  {months.map((m, i) => {
                    ...
                    if (paymentMode === "six" && i === paid) {
                      return (
                        <td key={i}>
                          <span className="due">₹{remaining}</span>
                        </td>
                      );
                    }
                    ...
                    if (paymentMode === "monthly" && i === paid) {
                      return (
                        <td key={i}>
                          <span className="due">₹{monthlyFee}</span>
                        </td>
                      );
                    }

                    return (
                      <td key={i} className="future">
                        To be paid
                      </td>
                    );
                  })}
