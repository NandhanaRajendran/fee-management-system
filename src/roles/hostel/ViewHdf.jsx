...
function ViewHdf() {
  ...
  const [students] = useState([
    { id: "S101", name: "Anu", month: "March", hdf: 800, status: "Pending" },
    { id: "S102", name: "Rahul", month: "March", hdf: 800, status: "Pending" },
    { id: "S103", name: "Meera", month: "March", hdf: 800, status: "Paid" },
  ]);
  ...
  const downloadCSV = () => {
    ...
    link.setAttribute("download", "hdf_dues.csv");
